...
$StatesModelCopyWith<StatesModel> get copyWith => _$StatesModelCopyWithImpl<StatesModel>(this as StatesModel, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is StatesModel&&(identical(other.id, id) || other.id == id)&&(identical(other.value, value) || other.value == value));
}
...
abstract mixin class $StatesModelCopyWith<$Res>  {
  factory $StatesModelCopyWith(StatesModel value, $Res Function(StatesModel) _then) = _$StatesModelCopyWithImpl;
@useResult
$Res call({
 int id, String value
});
...
@pragma('vm:prefer-inline')
_$StatesModelCopyWith<_StatesModel> get copyWith => __$StatesModelCopyWithImpl<_StatesModel>(this, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _StatesModel&&(identical(other.id, id) || other.id == id)&&(identical(other.value, value) || other.value == value));
}
...
abstract mixin class _$StatesModelCopyWith<$Res> implements $StatesModelCopyWith<$Res> {
  factory _$StatesModelCopyWith(_StatesModel value, $Res Function(_StatesModel) _then) = __$StatesModelCopyWithImpl;
@override @useResult
$Res call({
 int id, String value
});
